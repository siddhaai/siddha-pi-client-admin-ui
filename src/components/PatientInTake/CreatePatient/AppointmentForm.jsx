    ...
    <Formik
      ...
      onSubmit={(values, actions) => {
        ...
        if (!dateTimeValidationError) {
          onSubmit(values, actions); // Pass actions here
        } else {
          actions.setSubmitting(false); // Reset the submitting state if validation fails
        }
      }}
    >
      {({
                      ...
                      <Grid item xs={12}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DateTimePicker
                            ...
                            // Apply minTime and maxTime conditionally based on the selected date
                            minTime={
                              values.appointmentDateTime &&
                              dayjs(values.appointmentDateTime).isSame(
                                dayjs(),
                                "day"
                              )
                      ...
                      <Grid item xs={12}>
                        ...
                        >
                          ...
                          >
                            ...
                            <MenuItem value="383349">Siddha Office 2 </MenuItem>
